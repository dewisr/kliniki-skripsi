...
$ambil = $koneksidb->query("SELECT * FROM petugas");
...
<div class="table-responsive">
  <table  class="table table-striped table-bordered table-hover" id="dataTables-example"  width="100%"cellspacing="1" cellpadding="3">
      ...
      <?php
	$ambil = $koneksidb->query("SELECT * FROM petugas ORDER BY kd_petugas ASC");
  $pecah = $ambil->fetch_assoc();
	//$myQry 	= mysqli_query($mySql, $koneksidb)  or die ("Query  salah : ".mysql_error());
	$nomor  = 0; 
